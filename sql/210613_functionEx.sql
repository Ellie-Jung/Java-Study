----21.06.13 function 복습
--
--16. SUBSTR 함수를 사용하여 사원들의 입사한 년도와 입사한 달만 출력하시오.
select hiredate, substr(hiredate,1,5) as hireyearday
from emp;
...
--조인 이용
select e.deptno, dname, loc, count(*),round(avg(sal))
from emp e, dept d
